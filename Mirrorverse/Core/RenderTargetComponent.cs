...
public unsafe class RenderTargetComponent : Component
{
    ...
    {
        Resize(app, new Vector2D<int>(2560, 1440));
    }

    public ref ComPtr<ID3D11ShaderResourceView> RenderTarget => ref renderTargetResourceView;
    ...
    public void Resize(IApp app, Vector2D<int> windowSize)
    {
        ...
        renderTargetTextureDesc.Format =  Silk.NET.DXGI.Format.FormatR8G8B8A8Unorm;
